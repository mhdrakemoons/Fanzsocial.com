...
import { getAllProviderSummaries, getProviderBySlug } from "@/lib/twitter-providers";
      ...
      <div className="bg-blue-50 pt-6 md:pt-16 pb-6 md:pb-8">
        <div className="mx-auto max-w-6xl px-6 xl:px-0">
          <nav className="mb-8 flex items-center gap-2 text-sm">
            ...
            <Link href="/buy-twitter-likes-comments-followers" className="text-[#4A236C] hover:text-[#4A236C]/80 transition-colors">
