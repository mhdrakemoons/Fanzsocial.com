...
import { getAllProviderSummaries } from "@/lib/youtube-providers";

export const metadata = {
  title: "Your Best Site to Buy YouTube Views, Likes and Comments | Fanzsocial",
  description:
    "We review the best platforms to buy YouTube views, likes, and comments. Honest comparisons to help you grow your channel safely.",
};

export default function BuyYouTubeViewsLikesCommentsPage() {
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center py-6 md:py-10">
              <div className="z-10 flex flex-col items-center gap-3">
                <div className="flex items-center justify-center gap-2 text-sm text-gray-500 mb-1">
                  ...
                  <span className="text-gray-600">Buy YouTube Views, Likes & Comments</span>
                </div>
                ...
                <h1 className="text-[#111827] text-5xl sm:text-6xl md:text-7xl font-black leading-tight tracking-tighter max-w-4xl text-balance">
                  Your Best Site to Buy YouTube Views, Likes and Comments
                </h1>

                <h2 className="text-gray-600 text-lg font-normal leading-normal max-w-2xl text-balance">
                  We test the top platforms so you don&apos;t have to. Honest reviews of the best services to buy YouTube views, likes, and comments.
                </h2>
              ...
              <div className="relative z-10 mt-10 md:mt-12">
                <BlogGrid
                  posts={posts}
                  pageSize={9}
                  hrefBase="/buy-youtube-views-likes-comments"
                />
              </div>
            </div>
          </section>
